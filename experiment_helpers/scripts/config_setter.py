...
def plot_req(
    num_requests=100, num_tables=50, max_pages=100, q=0.5, p_scan=0.0, gamma=0, c_scan=0.7, c_get=1.0, name=""
):
...
class Board:
    ...
    def get_plot(self):
        ...
        c_scan = widgets.FloatSlider(
            self.cfg.cost_params.c_scan,
            min=0.0,
            max=1.0,
            step=0.01,
        )
        c_get = widgets.FloatSlider(
            self.cfg.cost_params.c_get,
            min=0.0,
            max=1.0,
            step=0.01,
        )
